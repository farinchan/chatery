                  ...
                  <ul class="nav flex-wrap border-transparent fw-bold">
                      <li class="nav-item my-1">
                          <a class="btn btn-color-gray-600 btn-active-secondary btn-active-color-primary fw-bolder fs-8 fs-lg-base nav-link px-3 px-lg-8 mx-1 text-uppercase
                              {{ request()->routeIs('back.whatsapp.documentation.sendMessage') ? 'active' : '' }}"
                              href="{{ route('back.whatsapp.documentation.sendMessage', request()->route('session')) }}">Kirim Pesan</a>
                      </li>
                      <li class="nav-item my-1">
                          <a class="btn btn-color-gray-600 btn-active-secondary btn-active-color-primary fw-bolder fs-8 fs-lg-base nav-link px-3 px-lg-8 mx-1 text-uppercase
                              {{ request()->routeIs('back.whatsapp.documentation.sendImage') ? 'active' : '' }}"
                              href="{{ route('back.whatsapp.documentation.sendImage', request()->route('session')) }}">Kirim Pesan Dengan Gambar</a>
                      </li>
                      <li class="nav-item my-1">
                          <a class="btn btn-color-gray-600 btn-active-secondary btn-active-color-primary fw-bolder fs-8 fs-lg-base nav-link px-3 px-lg-8 mx-1 text-uppercase
                                {{ request()->routeIs('back.whatsapp.documentation.sendDocument') ? 'active' : '' }}"
                              href="{{ route('back.whatsapp.documentation.sendDocument', request()->route('session')) }}">Kirim Pesan Dengan Dokumen</a>
                      </li>
                      <li class="nav-item my-1">
                          <a class="btn btn-color-gray-600 btn-active-secondary btn-active-color-primary fw-bolder fs-8 fs-lg-base nav-link px-3 px-lg-8 mx-1 text-uppercase
                              {{ request()->routeIs('back.whatsapp.documentation.sendBulkMessage') ? 'active' : '' }}"
                              href="{{ route('back.whatsapp.documentation.sendBulkMessage', request()->route('session')) }}">Kirim Pesan Massal</a>
                      </li>
                  </ul>
              </div>
          </div>
