    ...
    <div id="kt_content_container" class="container-xxl">
        ...
        <div class="card">
            ...
            <div class="card-body py-4">
                <form action="{{ route('back.admin.package.store') }}" method="POST">
                    @csrf
                                ...
                                <div class="col-md-6">
                                    <div class="mb-6">
                                        ...
                                        <input type="text" name="name"
                                            ...
                                            placeholder="Contoh: Free Tier, Platinum, Diamond" value="{{ old('name') }}" required />
                                        @error('name')
                                ...
                                <div class="col-md-6">
                                    <div class="mb-6">
                                        ...
                                        <input type="text" name="slug"
                                            ...
                                            placeholder="free-tier" value="{{ old('slug') }}" required />
                                ...
                                <div class="col-md-12">
                                    <div class="mb-6">
                                        ...
                                        <textarea name="description" rows="3"
                                            ...
                                            placeholder="Deskripsi package...">{{ old('description') }}</textarea>
                                        @error('description')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    </div>
                                    ...
                                    <div class="mb-6">
                                        ...
                                        <div class="input-group input-group-solid">
                                            ...
                                            <input type="number" name="price"
                                                ...
                                                placeholder="0" value="{{ old('price', 0) }}" min="0" required />
                                        </div>
                                        @error('price')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                ...
                                <div class="col-md-4">
                                    <div class="mb-6">
                                        ...
                                        <select name="billing_cycle"
                                            ...
                                            <option value="monthly" {{ old('billing_cycle') == 'monthly' ? 'selected' : '' }}>Per Bulan</option>
                                            <option value="yearly" {{ old('billing_cycle') == 'yearly' ? 'selected' : '' }}>Per Tahun</option>
                                            <option value="lifetime" {{ old('billing_cycle') == 'lifetime' ? 'selected' : '' }}>Selamanya</option>
                                        </select>
                                        @error('billing_cycle')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                ...
                                <div class="col-md-6">
                                    <div class="mb-6">
                                        ...
                                        <input type="color" name="badge_color"
                                            ...
                                            value="{{ old('badge_color', '#6c757d') }}" required />
                                        @error('badge_color')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    </div>
                                ...
                                <div class="col-md-6">
                                    <div class="mb-6">
                                        ...
                                        <input type="text" name="icon"
                                            ...
                                            placeholder="box, diamond, crown, rocket" value="{{ old('icon', 'box') }}" />
                                ...
                                <div class="col-md-4">
                                    <div class="mb-6">
                                        ...
                                        <input type="number" name="max_members"
                                            ...
                                            value="{{ old('max_members', 5) }}" min="-1" required />
                                        @error('max_members')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    </div>
                                ...
                                <div class="col-md-4">
                                    <div class="mb-6">
                                        ...
                                        <input type="number" name="max_whatsapp_sessions"
                                            ...
                                            value="{{ old('max_whatsapp_sessions', 1) }}" min="-1" required />
                                ...
                                <div class="col-md-4">
                                    <div class="mb-6">
                                        ...
                                        <input type="number" name="max_telegram_bots"
                                            ...
                                            value="{{ old('max_telegram_bots', 1) }}" min="-1" required />
                                ...
                                <div class="col-md-4">
                                    <div class="mb-6">
                                        ...
                                        <input type="number" name="max_webchat_widgets"
                                            ...
                                            value="{{ old('max_webchat_widgets', 1) }}" min="-1" required />
                                ...
                                <div class="col-md-4">
                                    <div class="mb-6">
                                        ...
                                        <input type="number" name="max_messages_per_day"
                                            ...
                                            value="{{ old('max_messages_per_day', 100) }}" min="-1" required />
                                ...
                                <div class="col-md-4">
                                    <div class="mb-6">
                                        ...
                                        <input type="number" name="message_history_days"
                                            ...
                                            value="{{ old('message_history_days', 30) }}" min="-1" required />
                                ...
                                <div class="col-md-3">
                                    <div class="form-check form-switch form-check-custom form-check-solid mb-5">
                                        <input class="form-check-input" type="checkbox" name="has_api_access" value="1"
                                            id="has_api_access" {{ old('has_api_access') ? 'checked' : '' }} />
                                ...
                                <div class="col-md-3">
                                    <div class="form-check form-switch form-check-custom form-check-solid mb-5">
                                        <input class="form-check-input" type="checkbox" name="has_webhook" value="1"
                                            id="has_webhook" {{ old('has_webhook') ? 'checked' : '' }} />
                                ...
                                <div class="col-md-3">
                                    <div class="form-check form-switch form-check-custom form-check-solid mb-5">
                                        <input class="form-check-input" type="checkbox" name="has_bulk_message" value="1"
                                            id="has_bulk_message" {{ old('has_bulk_message') ? 'checked' : '' }} />
                                ...
                                <div class="col-md-3">
                                    <div class="form-check form-switch form-check-custom form-check-solid mb-5">
                                        <input class="form-check-input" type="checkbox" name="has_auto_reply" value="1"
                                            id="has_auto_reply" {{ old('has_auto_reply', true) ? 'checked' : '' }} />
                                ...
                                <div class="col-md-3">
                                    <div class="form-check form-switch form-check-custom form-check-solid mb-5">
                                        <input class="form-check-input" type="checkbox" name="has_analytics" value="1"
                                            id="has_analytics" {{ old('has_analytics') ? 'checked' : '' }} />
                                ...
                                <div class="col-md-3">
                                    <div class="form-check form-switch form-check-custom form-check-solid mb-5">
                                        <input class="form-check-input" type="checkbox" name="has_export" value="1"
                                            id="has_export" {{ old('has_export') ? 'checked' : '' }} />
                                ...
                                <div class="col-md-3">
                                    <div class="form-check form-switch form-check-custom form-check-solid mb-5">
                                        <input class="form-check-input" type="checkbox" name="has_priority_support" value="1"
                                            id="has_priority_support" {{ old('has_priority_support') ? 'checked' : '' }} />
                                ...
                                <div class="col-md-3">
                                    <div class="form-check form-switch form-check-custom form-check-solid mb-5">
                                        <input class="form-check-input" type="checkbox" name="has_custom_branding" value="1"
                                            id="has_custom_branding" {{ old('has_custom_branding') ? 'checked' : '' }} />
