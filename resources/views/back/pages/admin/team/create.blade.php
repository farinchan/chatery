    ...
    <div id="kt_content_container" class="container-xxl">
        ...
        <div class="card">
            ...
            <div class="card-body py-4">
                <form action="{{ route('back.admin.team.store') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    <div class="row">
                        <!--begin::Col-->
                        <div class="col-md-4">
                        ...
                        <div class="col-md-8">
                            ...
                            <div class="row mb-6">
                                ...
                                <div class="col-lg-9">
                                    <input type="text" name="name"
                                        ...
                                        placeholder="Nama Team" value="{{ old('name') }}" required />
                                    @error('name')
                            ...
                            <div class="row mb-6">
                                ...
                                <div class="col-lg-9">
                                    <input type="text" name="name_id"
                                        ...
                                        placeholder="unique-team-id" value="{{ old('name_id') }}" required />
                            ...
                            <div class="row mb-6">
                                ...
                                <div class="col-lg-9">
                                    <input type="email" name="email"
                                        ...
                                        placeholder="team@example.com" value="{{ old('email') }}" />
                                    @error('email')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                            ...
                            <!--begin::Input group-->
                            <div class="row mb-6">
                                <label class="col-lg-3 col-form-label required fw-semibold fs-6">Owner</label>
                                <div class="col-lg-9">
                                    <select name="owner_id"
                                        class="form-select form-select-solid form-select-lg @error('owner_id') is-invalid @enderror"
                                        data-control="select2" data-placeholder="Pilih Owner" required>
                                    ...
                                    <div class="form-text">User yang akan menjadi owner team ini</div>
                                    @error('owner_id')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
