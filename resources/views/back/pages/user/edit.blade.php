                ...
                <form action="{{ route('back.user.update', $user->id) }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-8">
                            ...
                            <div class="notice d-flex bg-light-warning rounded border-warning border border-dashed mb-6 p-6">
                                ...
                                <div class="d-flex flex-stack flex-grow-1">
                                    <div class="fw-semibold">
                                        <div class="fs-6 text-gray-700">Kosongkan password jika tidak ingin mengubah password user.</div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <!--begin::Input group-->
                            <div class="row mb-6">
                                <label class="col-lg-3 col-form-label fw-semibold fs-6">Password Baru</label>
                                <div class="col-lg-9">
                            ...
                            <!--begin::Input group-->
                            <div class="row mb-6">
                                <label class="col-lg-3 col-form-label fw-semibold fs-6">Konfirmasi Password</label>
                                <div class="col-lg-9">
