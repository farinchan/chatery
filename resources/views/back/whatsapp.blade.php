                        ...
                        <div class="col-xxl-4 col-xl-5 col-lg-5 col-md-5">
                            <div class="card bg-white border-0 rounded-3 mb-4">
                                <div class="card-body p-4">
                                    ...
                                    <ul class="nav nav-tabs justify-content-between chat-tabs mb-4" id="myTab"
                                        role="tablist">
                                        <li class="nav-item" role="presentation">
                                            <button
                                                class="nav-link p-0 border-0 fw-medium text-body rounded-0 pb-2 active"
                                                id="all-message-tab" data-bs-toggle="tab"
                                                data-bs-target="#all-message-tab-pane" type="button" role="tab"
                                                aria-controls="all-message-tab-pane" aria-selected="true">All
                                                Message</button>
                                        </li>

                                        <li class="nav-item" role="presentation">
                                            <button class="nav-link p-0 border-0 fw-medium text-body rounded-0 pb-2"
                                                id="contacts-tab" data-bs-toggle="tab"
                                    ...
                                    <div class="tab-content" id="myTabContent">
                                        <div class="tab-pane fade show active" id="all-message-tab-pane"
                                            role="tabpanel" aria-labelledby="all-message-tab" tabindex="0">
                            ...
                            <div class="card bg-white border-0 rounded-3 mb-4">
                                <div class="card-body p-4">
                                    <div
                                        ...
                                        <div class="d-flex align-items-center">
                                            <div class="flex-shrink-0 position-relative">
                                                <img src="assets/images/user-49.jpg" class="wh-52 rounded-circle"
                                                    alt="user">
                                                <div
                                                    class="position-absolute p-1 bg-success border border-2 border-white rounded-circle status-position2">
                                                </div>
                                        ...
                                        <ul class="ps-0 mb-0 list-unstyled chat-call-option d-flex gap-1 gap-xl-3">
                                            ...
                                            <li>
                                                <div class="dropdown action-opt" data-bs-toggle="tooltip"
                                    ...
                                    <ul class="mb-0 list-unstyled chat-details max-h-419" data-simplebar>
                                        <li class="mb-4">
                                            <div class="d-sm-flex">
                                                ...
                                                <div class="flex-grow-1 ms-sm-3 mt-3 mt-sm-0">
                                                    <div class="d-flex align-items-center">
                                                        <p>Hey Micheals, have you had a chance to check out the new
                                                            admin
                                                            dashboard?</p>
                                        ...
                                        <li class="mb-4">
                                            <div class="d-sm-flex">
                                                ...
                                                <div class="flex-grow-1 ms-sm-3 mt-3 mt-sm-0">
                                                    <div class="d-flex align-items-center">
                                                        <p>Yeah, that's the one! It's got a sleek Material Design, and
                                                            the
                                                            features are pretty robust.</p>
                                        ...
                                        <li class="mb-4">
                                            <div class="d-sm-flex">
                                                ...
                                                <div class="flex-grow-1 ms-sm-3 mt-3 mt-sm-0">
                                                    <div class="d-flex align-items-center">
                                                        <p>Well, it has a project overview with all the key metrics on
                                                            the
                                            ...
                                            <div class="d-sm-flex text-end">
                                                <div class="flex-grow-1 mb-3 mb-sm-0">
                                                    <div class="d-flex align-items-center justify-content-end">
                                                        ...
                                                        <p>That sounds handy. How about the task management features?
                                                        </p>
                                                    </div>
                                                    <span class="fs-12 d-block">09:21 AM</span>
                                                </div>
                                        ...
                                        <li class="mb-4">
                                            <div class="d-sm-flex">
                                                ...
                                                <div class="flex-grow-1 ms-sm-3 mt-3 mt-sm-0">
                                                    <div class="d-flex align-items-center">
                                                        <p>Oh, they've got this Kanban board for task management. You
                                                            can drag
                                                            and drop tasks between columns – it's so intuitive.</p>
                                    ...
                                    <div
                                        ...
                                        <button class="p-0 border-0 bg-primary d-none d-sm-block rounded-1 ms-3">
                                            <i
                                                class="material-symbols-outlined fs-24 text-white wh-55 lh-55 d-inline-block">send</i>
                                        </button>
                                    </div>
                                </div>
                            </div>
