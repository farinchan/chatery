<div class="row justify-content-center">
                            ...
                            <ul class="ps-0 mb-0 list-unstyled chat-list">
                                @foreach ($ui as $u)
                                    <li wire:click="getChatMessages('{{ $u['id'] }}', '{{ $u['name'] }}', '{{ $u['picture'] }}')"
                                        ...
                                        wire:loading.class="pe-none opacity-50" wire:target="getChatMessages">
    ...
    <div class="col-xxl-8 col-xl-7 col-lg-7 col-md-7">
        <div class="card bg-white border-0 rounded-3 mb-4">
            <div wire:loading wire:target="getChatMessages" class="card-body p-4">
                <div class="d-flex justify-content-center align-items-center flex-column ga-2 min-h-400">
                    <div class="spinner-border text-primary" role="status" style="width: 3rem; height: 3rem;">
                        <span class="visually-hidden">Loading...</span>
                    </div>
                    <h4 class="fs-20 fw-semibold mb-2 mt-3">Loading messages...</h4>
                    <p class="mb-0 text-center">Please wait while we fetch the conversation.</p>
                </div>
            </div>

            <div wire:loading.remove wire:target="getChatMessages">
            @if ($messages && count($messages) > 0)
                <div class="card-body p-4">
                    <div
                        ...
                        <div class="d-flex align-items-center">
                            <div class="flex-shrink-0 position-relative">
                                <img src="{{ $selectedChatPicture ? $selectedChatPicture : 'https://ui-avatars.com/api/?background=random&name=' . urlencode($selectedChatName) }}"
                                    class="wh-52 rounded-circle" alt="user">
                                <div
                                    class="position-absolute p-1 bg-success border border-2 border-white rounded-circle status-position2">
                                </div>
                            </div>
                                ...
                                <li class="mb-4">
                                    <div class="d-sm-flex">
                                        <div class="flex-shrink-0">
                                            <img src="{{ $selectedChatPicture ? $selectedChatPicture : 'https://ui-avatars.com/api/?background=random&name=' . urlencode($selectedChatName) }}"
                                                class="wh-48 rounded-circle" alt="user">
                                        </div>
                    ...
                    <div
                        ...
                        <form wire:submit.prevent="sendMessage"
                            ...
                            <input type="text" wire:model="messageText"
                                class="form-control rounded-1 border-0 text-dark h-55" placeholder="Type your message"
